...
public class ConfigKeys {
   ...
   */
  public static final String CONTROLLER_BLOB_STAGING_BASE_PATH = "controller.blob.staging.base.path";
  ...
  */
  ...
  /**
   * Base path for blob-based push (PushType.BLOB) staging directory.
   * Servers use this to pull SST files that were generated by VPJ and uploaded to HDFS.
   * The full path is: {base_path}/{store}_v{version}/partition_{N}/
   */
  public static final String SERVER_BLOB_PUSH_STAGING_BASE_PATH = "server.blob.push.staging.base.path";
