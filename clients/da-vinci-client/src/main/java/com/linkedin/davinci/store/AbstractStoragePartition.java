...
public abstract class AbstractStoragePartition {
  ...
  /**
   * Ingest external SST files into this partition.
   ...
   */
  public void ingestExternalFiles(java.util.List<String> sstFilePaths, boolean isRmd) {
    throw new UnsupportedOperationException("Ingesting external SST files is not supported by this storage partition");
  }
